...
The NPC builder SHALL place blocks on the mascot's XZ grid plane, preserve the mascot's Y coordinate, define positive Z
as front, and search deterministic concentric rings from the mascot outward.
...
and SHALL leave all existing blocks unchanged.
